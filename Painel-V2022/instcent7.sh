...
wget https://github.com/wellzin-blip/new2022/raw/master/Painel-V2022/phpMyAdmin.conf -O /etc/httpd/conf.d/phpMyAdmin.conf
...
installweb(){
cd /var/www/html
wget https://github.com/wellzin-blip/new2022/raw/master/Painel-V2022/gestorssh.zip
unzip gestorssh.zip
...
createdb(){
wget https://github.com/wellzin-blip/new2022/raw/master/Painel-V2022/bdgestorssh.sql
...
cd $HOME || exit
wget -qO- https://github.com/wellzin-blip/new2022/raw/master/Painel-V2022/uteste > /bin/usersteste.sh
wget -qO- https://github.com/wellzin-blip/new2022/raw/master/Painel-V2022/backupauto > /bin/autobackup.sh
